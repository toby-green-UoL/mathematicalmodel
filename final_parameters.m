...
if collector_linear_fresnel == true
    ...
    linear_fresnel_tracking = false;
    number_of_mirrors = 24;
    mirror_size_x = 0.0254;
    mirror_size_y = 0.6;
    mirror_centre_y = 0.5;
    mirror_centre_z = 0.2;
    mirror_first_x = 0.175;
    mirror_spacing_x = 0.0254;
end
...
if absorber_design_pipe == true
    ...
    absorber_pipe_x = 0.7; % centre point, not end point
    absorber_pipe_y = 0.5; % centre point, not end point
    absorber_pipe_z = 0.3; % centre point, not end point
    absorber_pipe_radius = 0.0127; % radius
    absorber_pipe_length = 1; % length
