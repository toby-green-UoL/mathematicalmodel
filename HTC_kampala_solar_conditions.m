...
if light_source_user_defined == true
    ...
    time_hours_stop = 14; % this is for running the model
end
...
rays_aperture_min_x = -2;
rays_aperture_max_x = 2;
rays_aperture_min_y = -2;
rays_aperture_max_y = 2;
rays_aperture_z = 0;
...
%     time_x_axis = linspace(0,24,500001); % x axis
%     single_day_irradiance_data = 1.075*measured_irradiance(2:4,800000:1300000); % y axis
%     figure(9);
%     % Create the plot
...
%     ylim([0 1000])
%     % Label the plot
%     title('Solar irradiance in Kampala during a 24hr period in July 2019')
%     xlabel('time (hours)')
