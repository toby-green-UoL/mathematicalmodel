...
if process_continuous == true
    water_flow_rate = 2.77E-6; % m^3 s^-1 flow rate of solar sim is 1L/5min
end
...
rays_aperture_min_x = -2.5;
rays_aperture_max_x = 2.5;
rays_aperture_min_y = -1;
...
h_c_water_reactor = 400;                            %Dr. Abdul Jabbar, IJAIEM, 5,4, 2016 
